...
texts.instructions = '<br><h2 style="text-align: center">Instructions</h2><p style="text-align: center">Thank you for \
					  ...
					  <p><br>In this experiment your task is to make judgments on words. All words \
                      ...
                      <strong>right</strong> arrow key.</li></ul><br><p>The experiment will be organized into several short blocks of six trials. The time between successive trials will vary from one block to another. You will first do one practice block, followed by six serious blocks.</p><p>Please try to make your judgement as quickly and as accurately as possible. If you make three or more errors in one block, you will have to do a new block to replace it.</p>\
                      <p>Please click on "next" to start with the practice block.</p>'
...
texts.end_fullscreen = 'That was all! Now we kindly ask you to answer a few questions about yourself. In order to do that, fullscreen mode will be exited and you will be forwarded to the questionnaire.'
...
texts.debriefing = '<p><h2>Thank you again for participating in our experiment.</h2></p><p> The goal of this experiment was \
                   to investigate how people remember information they were not instructed to remember \
                   and whether this is accomplished better or worse when more time is available. To \
                   that end we tested your memory for the six words of the last block. \
                   We varied the free time following each of the words between blocks - either only \
                   ...
                   this information with anyone! It is crucial that the explanation is kept confidential until we \
