...
ITI.push(2000, 5000);    		// for Version B that would be (2000, 5000)
...
var study_info = {
	...
	"<p>We would like to invite you to participate in our experiment. Please read carefully the following information.</p>"+
	"<dl><dt style='font-size: 105%;line-height: 2;'>What is it about?</dt><dd>In this study, we try to find out what influences people's judgement abilities. "+
	"Your task will be to make judgements about the size of different items.</dd>"+
	"<dt style='font-size: 105%;line-height: 2;'>Duration and payment</dt><dd>The experiment will take 5-10 minutes and you will recieve the before mentioned payment regardless of your performance.</dd>"+
	...
	"We do not collect data that could be used to identify you. The collected data can - in encrypted form only - be made available for other researchers.</dd></dl>"+
...
var inter = {
	type: 'text',
	cont_key: [32],
	text: '<h3 style="line-height: 1; margin-top:200px;text-align: center">Press the spacebar to start the next trial.</h3>'
}
...
var repLoop ={
	timeline: [infoRepeat, rep1, rep2, rep3, rep4, rep5, rep6],
...
var Intro2 = {
	type: 'text',
	cont_key: 'mouse',
	text: '<h4 style="margin-top:200px">Next follow the six test-trials.</h4>' +
	...
	'<p style="line-height: 3">Press "Continue" to start the trials.</p>'+
	'<div class="jspsych-instructions-nav"><button id="jspsych-instructions-next" class="jspsych-btn">Continue &gt;</button></div>'
}
