...
jsPsych.plugins.fullscreen = (function(){
    ...
    plugin.trial = function(display_element, trial){
      ...
      $('#jspsych-target').append("<div id='text-container' class='jspsych-display-element'>")
      $('#text-container').append(trial.showtext)
      $('#text-container').append("<div class='jspsych-instructions-nav'><button id='jspsych-fullscreen-button' class='jspsych-btn'>" + trial.buttontext + "</button></div>");
