 ...
 *
 * Adapted by Danielle Pessach FEB16
 */
...
jsPsych.plugins['survey'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
	...
	if (trial.options[i] === "0") {
		$(question_selector).append('<textarea id="text" name="#jspsych-survey-text-response-' + i + '" cols="20" rows="1" input type="text"></textarea>');
